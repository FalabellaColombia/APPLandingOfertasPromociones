      ...
      <DropdownMenuContent>
        {currentView === VIEW_VISIBLEPRODUCTS ? (
          <>
            ...
            <DropdownMenuItem onClick={() => handleHideProduct(productInfo)}>Ocultar</DropdownMenuItem>
          </>
        ) : (
          <DropdownMenuItem onClick={() => handleUnhideProduct(productInfo)}>Desocultar</DropdownMenuItem>
        )}
        <DropdownMenuSeparator />
        <AlertDialog>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={handleDeleteAndClose}>Eliminar</AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
      </DropdownMenuContent>
